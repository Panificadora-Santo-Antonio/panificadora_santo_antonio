...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post estoques_url, params: { estoque: { produto_id: @estoque.produto_id, quantidadeProduto: @estoque.quantidadeProduto, valorTotalEstoque: @estoque.valorTotalEstoque } }
  #   end
  ...
  #   patch estoque_url(@estoque), params: { estoque: { produto_id: @estoque.produto_id, quantidadeProduto: @estoque.quantidadeProduto, valorTotalEstoque: @estoque.valorTotalEstoque } }
