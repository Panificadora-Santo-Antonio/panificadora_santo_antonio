...
class ProductSalesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post product_sales_url, params: { product_sale: { quantity: @product_sale.quantity, totalProductPrice: @product_sale.totalProductPrice } }
  #   end
  ...
  #   patch product_sale_url(@product_sale), params: { product_sale: { quantity: @product_sale.quantity, totalProductPrice: @product_sale.totalProductPrice } }
