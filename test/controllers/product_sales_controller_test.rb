...
class ProductSalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_sale" do
    assert_difference('ProductSale.count') do
      post product_sales_url, params: { product_sale: { produto_id: @product_sale.produto_id, quantity: @product_sale.quantity, sale_id: @product_sale.sale_id, total_product_price: @product_sale.total_product_price } }
    end
  ...
  test "should update product_sale" do
    patch product_sale_url(@product_sale), params: { product_sale: { produto_id: @product_sale.produto_id, quantity: @product_sale.quantity, sale_id: @product_sale.sale_id, total_product_price: @product_sale.total_product_price } }
