...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post produtos_url, params: { produto: { descrição: @produto.descrição, nome: @produto.nome, preco: @produto.preco, validade: @produto.validade } }
  #   end
  ...
  #   patch produto_url(@produto), params: { produto: { descrição: @produto.descrição, nome: @produto.nome, preco: @produto.preco, validade: @produto.validade } }
